...
```
Initially, seagrass in sponge plots had significantly lower nitrogen concentrations than control plots (Fig. \@ref(fig:nuts)A, t~`r round(nbs$coefficients[3,3],0)`~ = `r round(nbs$coefficients[3,4],2)`, `r ifelse(nbs$coefficients[3,5]< 0.001, "p < 0.001", paste("p =", round(nbs$coefficients[3,5],2)))`) but not structure control plots (t~`r round(nfs$coefficients[3,3],0)`~ = `r round(nfs$coefficients[3,4],2)`, `r ifelse(nfs$coefficients[3,5]< 0.001, "p < 0.001", paste("p =", round(nfs$coefficients[3,5],2)))`). Percent nitrogen in seagrass tissues in both control and structure control plots declined over time (Fig. \@ref(fig:nuts)A, t~`r round(nbs$coefficients[5,3],0)`~ = `r round(nbs$coefficients[5,4],2)`, `r ifelse(nbs$coefficients[5,5]< 0.001, "p < 0.001", paste("p =", round(nbs$coefficients[5,5],2)))`), but the decrease was only significant in control plots (control: t~`r round(nbs$coefficients[4,3],0)`~ = `r round(nbs$coefficients[4,4],2)`, `r ifelse(nbs$coefficients[4,5]< 0.001, "p < 0.001", paste("p =", round(nbs$coefficients[4,5],2)))`, structure control: t~`r round(nfs$coefficients[4,3],0)`~ = `r round(nfs$coefficients[4,4],2)`, `r ifelse(nfs$coefficients[4,5]< 0.001, "p < 0.001", paste("p =", round(nfs$coefficients[4,5],2)))`). Conversely, seagrass in sponge plots responded differently than both the control (t~`r round(nrs$coefficients[5,3],0)`~ = `r round(nrs$coefficients[5,4],2)`, `r ifelse(nrs$coefficients[5,5]< 0.001, "p < 0.001", paste("p =", round(nrs$coefficients[5,5],2)))`) and structure control (t~`r round(nrs$coefficients[6,3],0)`~ = `r round(nrs$coefficients[6,4],2)`, `r ifelse(nrs$coefficients[6,5]< 0.001, "p < 0.001", paste("p =", round(nrs$coefficients[6,5],2)))`) plots: it had a higher % nitrogen after one year (Fig. \@ref(fig:nuts)A). However, this increase was not significant (t~`r round(nrs$coefficients[4,3],0)`~ = `r round(nrs$coefficients[4,4],2)`, `r ifelse(nrs$coefficients[4,5]< 0.001, "p < 0.001", paste("p =", round(nrs$coefficients[4,5],2)))`).  
The pattern was similar for percent carbon, seagrass in sponge plots was initially lower than control (Fig. \@ref(fig:nuts)B, t~`r round(cbs$coefficients[3,3],0)`~ = `r round(cbs$coefficients[3,4],2)`, `r ifelse(cbs$coefficients[3,5]< 0.001, "p < 0.001", paste("p =", round(cbs$coefficients[3,5],2)))`) and structure control plots (t~`r round(cfs$coefficients[3,3],0)`~ = `r round(cfs$coefficients[3,4],2)`, `r ifelse(cfs$coefficients[3,5]< 0.001, "p < 0.001", paste("p =", round(cfs$coefficients[3,5],2)))`). Again, percent carbon in seagrass tissue decreased in a similar way in both control and structure control plots (Fig. \@ref(fig:nuts)A, t~`r round(cbs$coefficients[5,3],0)`~ = `r round(cbs$coefficients[5,4],2)`, `r ifelse(cbs$coefficients[5,5]< 0.001, "p < 0.001", paste("p =", round(cbs$coefficients[5,5],2)))`). However, this decrease was only significant in structure control plots (control: t~`r round(cbs$coefficients[4,3],0)`~ = `r round(cbs$coefficients[4,4],2)`, `r ifelse(cbs$coefficients[4,5]< 0.001, "p < 0.001", paste("p =", round(cbs$coefficients[4,5],2)))`, structure control: t~`r round(cfs$coefficients[4,3],0)`~ = `r round(cfs$coefficients[4,4],2)`, `r ifelse(cfs$coefficients[4,5]< 0.001, "p < 0.001", paste("p =", round(cfs$coefficients[4,5],2)))`). In sponge plots, % carbon showed a slight increased in seagrass tissues (t~`r round(crls$coefficients[4,3],0)`~ = `r round(crls$coefficients[4,4],2)`, `r ifelse(crls$coefficients[4,5]< 0.001, "p < 0.001", paste("p =", round(crls$coefficients[4,5],2)))`), resulting in a significantly different response than structure control plots (t~`r round(crls$coefficients[6,3],0)`~ = `r round(crls$coefficients[6,4],2)`, `r ifelse(crls$coefficients[6,5]< 0.001, "p < 0.001", paste("p =", round(crls$coefficients[6,5],2)))`) but not control plots (t~`r round(crls$coefficients[5,3],0)`~ = `r round(crls$coefficients[5,4],2)`, `r ifelse(crls$coefficients[5,5]< 0.001, "p < 0.001", paste("p =", round(crls$coefficients[5,5],2)))`).  
Phosphorus concentrations were similar in all plot types at the beginning of the experiment (Fig. \@ref(fig:nuts)C, control:structure control t~`r round(pbs$coefficients[2,3],0)`~ = `r round(pbs$coefficients[2,4],2)`, `r ifelse(pbs$coefficients[2,5]< 0.001, "p < 0.001", paste("p =", round(pbs$coefficients[2,5],2)))`; control:sponge t~`r round(pbs$coefficients[3,3],0)`~ = `r round(pbs$coefficients[3,4],2)`, `r ifelse(pbs$coefficients[3,5]< 0.001, "p < 0.001", paste("p =", round(pbs$coefficients[3,5],2)))`; structure control:sponge t~`r round(pfs$coefficients[3,3],0)`~ = `r round(pfs$coefficients[3,4],2)`, `r ifelse(pfs$coefficients[3,5]< 0.001, "p < 0.001", paste("p =", round(pfs$coefficients[3,5],2)))`). Although % phosphorus in seagrass tissues followed the same patterns as both % nitrogen and % carbon, decreasing in control (Fig. \@ref(fig:nuts)C, t~`r round(pbs$coefficients[4,3],0)`~ = `r round(pbs$coefficients[4,4],2)`, `r ifelse(pbs$coefficients[4,5]< 0.001, "p < 0.001", paste("p =", round(pbs$coefficients[4,5],2)))`) and structure control plots (t~`r round(pfs$coefficients[4,3],0)`~ = `r round(pfs$coefficients[4,4],2)`, `r ifelse(pfs$coefficients[4,5]< 0.001, "p < 0.001", paste("p =", round(pfs$coefficients[4,5],2)))`) while increasing in sponge plots (Fig. \@ref(fig:nuts)C, t~`r round(prs$coefficients[4,3],0)`~ = `r round(prs$coefficients[4,4],2)`, `r ifelse(prs$coefficients[4,5]< 0.001, "p < 0.001", paste("p =", round(prs$coefficients[4,5],2)))`), none of these changes are significant. However, the pattern of change over time was significantly different between control and sponge plots (t~`r round(prs$coefficients[5,3],0)`~ = `r round(prs$coefficients[5,4],2)`, `r ifelse(prs$coefficients[5,5]< 0.001, "p < 0.001", paste("p =", round(prs$coefficients[5,5],2)))`), but not between structure control and sponge plots (t~`r round(prs$coefficients[6,3],0)`~ = `r round(prs$coefficients[6,4],2)`, `r ifelse(prs$coefficients[6,5]< 0.001, "p < 0.001", paste("p =", round(prs$coefficients[6,5],2)))`) or control and structure control plots (t~`r round(pfs$coefficients[5,3],0)`~ = `r round(pfs$coefficients[5,4],2)`, `r ifelse(pfs$coefficients[5,5]< 0.001, "p < 0.001", paste("p =", round(pfs$coefficients[5,5],2)))`).
