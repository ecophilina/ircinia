...
Seagrass growth (mm^2^) was divided by the collection day in order to attain a value consistent across time (called growth per day). Because sampling 1 was our preliminary data and seasonal variation occured, sampling 1 was removed from the data set. Sampling 1&3 were categorized as summer and sampling 2&4 were winter.We created a lag but I am unsure why... "possible predictor variables". Distances were pooled at 0-0.5 m and 1.0-2.0 m and termed "closer" and "further" distance respectively. A linear model was made
