...
**Do we need any summary results here or discussion? e.g. Seagrass shoot density and nutrient levels did not show evidence of a seasonal effect, while growth and algal abundance did.**   
...
#       group = treatment),
#     lwd = 2) +
#   scale_fill_viridis_d(name=" ", option="A", begin=0, end=0.6, guide =F) +
#   scale_colour_viridis_d(name=" ", option="A", begin=0, end=0.6, guide =F) +
...
# ggsave("figures/algae_summer_means_viridis_95CIbw.jpg", plot = algaeplot, width = 7,height=4)

knitr::include_graphics("figures/algae_summer_means_viridis_95CI.jpg")
```
...
# scale_color_viridis_d(option="D", begin=0, end=0.6,
#                    name="",
#                    labels=c("Control","Structure control","Sponge"))+
#   theme_bw()+
#   theme(panel.grid = element_blank(),
