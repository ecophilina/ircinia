...
Unfortunately, samples for nutrient analysis were lost after collection, resulting in an unbalanced sampling design and even smaller sample sizes(Table \@ref(tab:ntable)). 
...
```
Consequently, for the primary analysis presented in the main text, we chose to examine the change in nutrient levels in seagrass closest to the center of our plots one year into the experiment as this allows us   
