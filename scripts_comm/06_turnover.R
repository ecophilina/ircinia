...
write_rds(summary(inv.gain1),"working_data/invgain1.rds")
write_rds(summary(inv.gain12),"working_data/invgain12.rds")
write_rds(TukeyHSD(inv.gain12),"working_data/invgain12_tukey.rds")
write_rds(summary(inv.loss1),"working_data/invloss1.rds")
write_rds(summary(inv.loss12),"working_data/invloss12.rds")
...
write_rds(summary(fish.gain1),"working_data/fishgain1.rds")
write_rds(summary(fish.gain12),"working_data/fishgain12.rds")
write_rds(TukeyHSD(fish.gain12),"working_data/fishgain12_tukey.rds")
write_rds(summary(fish.loss1),"working_data/fishloss1.rds")
