...
We hypothesized that this would result in sponge presence facilitating seagrass bed primary producers. 
...
Further, Archer et al. (2015) showed that a different sponge (*Halichondria melanadocia*) can provide nutrients to seagrasses. However, this study, to the best of our knowledge, is the first to show that a single massive form sponge can increase nutrient content in seagrasses within a 0.25 m radius. \par
...
It is possible that simply the addition of structure to our plots altered water flow and influenced the primary producers. 
...
This suggests that it is the sponges, rather than the presence of structure, that lead to increased seagrass nutrient content and growth, and increased abundance of both seagrasses (*S. filliforme* and *H. wrightii*) and macroalgae.\par

While our study is the first to show facilitation of primary producers in seagrass beds by sponges; seagrasses are often facilitated by other filter feeders, such as bivalves, increasing nutrient availability [@gagnon2020]. 
...
```{r nuts, out.width="65%", echo=FALSE,message=FALSE, fig.cap="Seagrass nutrient concentrations prior to the initiation of the experiment and at one year into the experiment. (A) Percent nitrogen, (B) percent carbon, and (C) percent phosphorus in Thalassia testudinum tissue."}
