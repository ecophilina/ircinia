...
Recent theoretical work has emphasized the potential for facilitative interactions involving foundation species to be destabilizing in the face of anthropogenic change.
...
While sponges are also common in tropical and subtropical seagrass beds, we know little about how their presence impacts these communities.
...
This study showed facilitation of primary production in a seagrass bed by *I. felix* under oligotrophic conditions. 
...
It is important to understand facilitation of foundation species, like seagrass, because this can have cascading consequences on local diversity, ecosystem function, and the delivery of ecosystem services.
...
```{r shootd, out.width="55%", echo=FALSE,message=FALSE, fig.cap="Shoot densities (means and 95% confidence intervals) of (a) *T. testudinum* and (b) *S. filliforme* and *H. wrightii* combined over the course of the experiment."}
knitr::include_graphics("figures/shootdensity-95CI.jpg")
```


```{r grow, out.width="85%", echo=FALSE,message=FALSE, fig.cap="Segrass growth (means and 95% confidence intervals) in the summer (a) and winter (b) over the course of the experiment. Summer sampling happened in months 1 and 12 (years 1 and 2 respectively) while winter sampling occurred in months 5 and 17."}
knitr::include_graphics("figures/sggrow-95CI.jpg")
```


```{r nuts, out.width="65%", echo=FALSE,message=FALSE, fig.cap="Seagrass nutrient concentrations (means and 95% confidence intervals) prior to the initiation of the experiment and at one year (12 months) into the experiment. (a) Percent nitrogen, (b) percent carbon, and (c) percent phosphorus in *Thalassia testudinum* tissue."}
