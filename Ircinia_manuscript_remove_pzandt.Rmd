...
Recent theoretical work has highlighted the potential for **highlighted the potential for- sounds positive when I think the destabilization is negative or maybe I have it reversed. I would use "has emphasized the potenial for" or "has suggested** facilitative interactions involving foundation species to be destabilizing in the face of anthropogenic change.
Consequently, it is becoming more important to understand which taxa facilitate seagrasses.
Sponges are a common component of seagrass bed communities. **Remove this sentence. I think the paragraph flows just fine without it**
...
However, we know little about how sponge presence impacts *Thalassia testudinum* dominated seagrass beds.
Here we examine the impact of the sponge *Ircinia felix* on saeagrass bed primary producers in The Bahamas using a long-term field experiment. 
...
Specifically, sponge presence results in increased seagrass nutrient content and growth and increased abundance of both macroalgae and seagrasses.\par  
...
Further, Archer et al. (2015) showed that a different sponge (*Halichondria melanadocia*) that grows around the base and leaves of seagrass shoots likely provide nutrients to those shoots. 
...
While **Although instead of while?** our study is the first to show facilitation of primary producers in seagrass beds by sponges, seagrasses are often facilitated by other filter feeders increasing nutrient availability [@gagnon2020].
