...
The ecosystem engineering concept is still a relatively new term and, thus, researchers are continuously identifying which species are acting as ecosystem engineers in many systems[Byers2006].
Consequently, it is important that we continue to identify ecosystem engineers and their cascading effects on associated communities, especially due to the overexploitation of many marine ecosystem engineers [@Coleman2002].\par
...
We believe that marine sponges have the potential to act as ecosystem engineers in seagrass beds because of the functions they provide as autogenic and allogenic ecosystem engineers while also significantly affecting other organism within their community. \par

One of the main contributions by marine sponges that categorize them as ecosystem engineers is their addition to the structural complexity of seagrass habitats. 
...
It was only within the first month of the experiment that 3 live sponges needed to and were replaced. \par
...
We chose candidate model configurations that represented different biological hypotheses and used the package AICcmodavg [@Mazerolle2020] to create a model selection tables based on Akaike Infromation Criterion scores (AICc). 
