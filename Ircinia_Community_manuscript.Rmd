...
To visualize changes in taxa richness over time (i.e. taxa gained or lost relative to the total number of taxa observed across the two sampling events in July), we used the turnover function in codyn package [@Hallett2020] to visualize the proportion of species lost by the proportion of species gained. Taxa turnover was performed on the community data for each plot and compared among treatments at 1 month into the experiment and 12 months into the experiment.
...
We separately analyzed fish, non-clonal invertebrate, and clonal invertebrate differences in compositional vector's angle (direction) and length across species space. 
