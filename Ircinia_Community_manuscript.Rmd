...
<!-- FMC- I like changing fish and invertebrate to animal in the sentence to avoid repeating that phrase. I think for the abstract saying they are possibly an ecosystem engineer is good and then if the reader wants to know how they can dig into the intro/discussion. Or maybe "Sponges possess many traits (e.g., create complex structure) that suggest they may be another example, but we know little about their relationships with animal communities in seagrass systems.  -->
...
<!-- I feel like something is missing in between these two sentences. Maybe another reminder of how sponges are common in seagrass beds? Just a sentence to help transition from talking about sponges to talking about seagrass -->
...
<!-- The last 2 sd in this paragraph are showing up as NA.... not sure why though -->
...
<!-- Taxa space has not been italicized up to this point -->
...
For example, the snapping shrimp living within large sponges contribute to the auditory cues that juvenile spiny lobsters (*Panulirus argus*) use to identify suitable settlement habitat [@Butler1995; @Butler2016].
