...
How about "Our study shows that sponges can act as ecosystem engineers in seagrass systems, however, additional research is needed to determine the full extent and implications of their effects.\par 
...
Likely as a result of the this nutrient cycling, at lease one sponge, *Ircinia felix* facilitates primary producers (seagrasses and macroalgae) in sub-tropical seagrass beds [@Archer2021].
...
We predicted that seagrass plots with *I. felix* would have higher taxa richness and abundance than seagrass plots without *I felix*.
...
When significant differences were detected we compared treatments using Tukey Post Hoc tests.\par
...
Overtime, sponge presence was associated with gaining more fish and invertebrate taxa and an increase in the retention of fish taxa but not of invertebrates.
...
This suggests that sponge presence may impact the invertebrate community indirectly via the enhancement of primary producers (i.e. seagrass and macroalgae), although not as much as sponge presence alone. 
In @Archer2021, macroalgal and seagrass abundance significantly increased over time in the presence of *I. felix*. 
Other studies support the idea that marcoinvertebrates richness and abundance increase with increasing seagrass shoot density[@Webster1998]. 
...
The added structural complexity of the seagrass bed from the sponge, along with the increase of food availability with sponge presence, could explain the increase in fish and richness and abundance.
...
Likely, the increased taxa richness and abundance of invertebrates with sponge presence contributed to the colonization of structure-associated fish species that could take advantage of increased invertebrate abundance.
Further research is needed to tease apart the relative importance of increased structural complexity and food availability as a result of sponge presence. \par
...
We studied the effect of the presence of an ecosystem engineer, *I felix*, on taxa richness, abundance, turnover, and community composition in low-impact seagrass beds and found that sponge presence can increase taxa richness and abundance, reduce turnover rates, and shift fish communities.
